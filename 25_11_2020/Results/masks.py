...
chunk.importMasks(path='Links_Initial.jpg',tolerance=tol,cameras=cameras[0])
chunk.importMasks(path='Links_Regular.jpg',tolerance=tol,cameras=cameras[1:21])
chunk.importMasks(path='Midden_Initial.jpg',tolerance=tol,cameras=cameras[21])
chunk.importMasks(path='Midden_Regular.jpg',tolerance=tol,cameras=cameras[22:42])
chunk.importMasks(path='Rechts_Initial.jpg',tolerance=tol,cameras=cameras[42])
chunk.importMasks(path='Rechts_Regular.jpg',tolerance=tol,cameras=cameras[43:64])
